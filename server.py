...
while True:
    ...
    try:
        ...
        if not valid_mv:
            ...
            print('[%d_2]Invalid move by %d - %s. Player %d - %s (%s) wins. Game finished. ' % (1 - (idx_move % 2), idx_move % 2, nicks[idx_move % 2], 1 - (idx_move % 2), nicks[1 - (idx_move % 2)], colors[1 - (idx_move % 2)]))
            file_out.write('[%d_2]Invalid move by %d - %s. Player %d - %s (%s) wins. Game finished. ' % (1 - (idx_move % 2), idx_move % 2, nicks[idx_move % 2], 1 - (idx_move % 2), nicks[1 - (idx_move % 2)], colors[1 - (idx_move % 2)]))
            break
        ...
        if finish < 2:
            ...
            file_out.write('[%d_0]Player %d - %s (%s) wins. Game finished. ' % (finish, finish, nicks[finish], colors[finish]))
            break
        ...
        if moves_without_eat >= moves_without_eat_to_draw:
            print('[2_0]%d consecutives without eaten pieces. %s - %s Draw. Game finished. ' % (moves_without_eat, nicks[0], nicks[1]))
            file_out.write('[2_0]%d consecutives without eaten pieces. %s - %s Draw. Game finished. ' % (moves_without_eat, nicks[0], nicks[1]))
            break
        ...
        print('Exception! ', err)
        print('[%d_1]Timeout by %d - %s: %s. Player %d - %s (%s) wins. Game finished. ' % ( 1 - (idx_move % 2), idx_move % 2, nicks[idx_move % 2], colors[idx_move % 2], 1 - (idx_move % 2), nicks[1 - (idx_move % 2)], colors[1 - (idx_move % 2)]))
        file_out.write('[%d_1]Timeout by %d - %s: %s. Player %d - %s (%s) wins. Game finished. ' % (1 - (idx_move % 2), idx_move % 2, nicks[idx_move % 2], colors[idx_move % 2], 1 - (idx_move % 2), nicks[1 - (idx_move % 2)], colors[1 - (idx_move % 2)]))
        break
